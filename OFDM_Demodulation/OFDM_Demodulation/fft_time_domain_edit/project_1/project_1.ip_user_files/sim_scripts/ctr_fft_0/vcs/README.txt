...
#
# Generated by export_simulation on Thu Nov 20 22:23:50 -0500 2025
#
################################################################################
...
'-reset_run' switch to the './ctr_fft_0.sh' script.

./ctr_fft_0.sh -reset_run
...
./ctr_fft_0.sh -noclean_files

For more information on the script, please type './ctr_fft_0.sh -help'.
