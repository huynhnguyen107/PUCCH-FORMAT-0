...
#
# Generated by export_simulation on Sat Dec 27 21:59:38 -0500 2025
#
################################################################################
...
'-reset_run' switch to the './xcorr_fifo_generator_0.sh' script.

./xcorr_fifo_generator_0.sh -reset_run
...
./xcorr_fifo_generator_0.sh -noclean_files

For more information on the script, please type './xcorr_fifo_generator_0.sh -help'.
