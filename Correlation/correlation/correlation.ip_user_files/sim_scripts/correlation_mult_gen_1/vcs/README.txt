...
#
# Generated by export_simulation on Sun Dec 28 01:08:47 -0500 2025
#
################################################################################
...
'-reset_run' switch to the './correlation_mult_gen_1.sh' script.

./correlation_mult_gen_1.sh -reset_run
...
./correlation_mult_gen_1.sh -noclean_files

For more information on the script, please type './correlation_mult_gen_1.sh -help'.
