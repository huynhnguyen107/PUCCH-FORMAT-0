...
#
# Generated by export_simulation on Mon Dec 29 23:20:25 -0500 2025
#
################################################################################
...
'-reset_run' switch to the './rx_dup_mem_1.sh' script.

./rx_dup_mem_1.sh -reset_run
...
./rx_dup_mem_1.sh -noclean_files

For more information on the script, please type './rx_dup_mem_1.sh -help'.
