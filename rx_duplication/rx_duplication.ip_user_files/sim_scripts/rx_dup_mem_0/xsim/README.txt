...
#
# Generated by export_simulation on Sat Jan 03 01:42:42 -0500 2026
#
################################################################################
...
'-reset_run' switch to the './rx_dup_mem_0.sh' script.

./rx_dup_mem_0.sh -reset_run
...
./rx_dup_mem_0.sh -noclean_files

For more information on the script, please type './rx_dup_mem_0.sh -help'.
