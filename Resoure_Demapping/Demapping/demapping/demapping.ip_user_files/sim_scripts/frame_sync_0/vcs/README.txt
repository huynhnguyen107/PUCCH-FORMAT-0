...
#
# Generated by export_simulation on Sun Dec 14 20:37:43 -0500 2025
#
################################################################################
...
'-reset_run' switch to the './frame_sync_0.sh' script.

./frame_sync_0.sh -reset_run
...
./frame_sync_0.sh -noclean_files

For more information on the script, please type './frame_sync_0.sh -help'.
