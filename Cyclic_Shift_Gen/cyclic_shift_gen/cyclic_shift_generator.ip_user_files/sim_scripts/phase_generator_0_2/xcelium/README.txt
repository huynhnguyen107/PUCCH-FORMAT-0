...
#
# Generated by export_simulation on Thu Dec 25 01:05:10 -0500 2025
#
################################################################################
...
'-reset_run' switch to the './phase_generator_0.sh' script.

./phase_generator_0.sh -reset_run
...
./phase_generator_0.sh -noclean_files

For more information on the script, please type './phase_generator_0.sh -help'.
