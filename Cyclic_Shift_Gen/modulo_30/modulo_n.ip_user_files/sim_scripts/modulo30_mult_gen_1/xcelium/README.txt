...
#
# Generated by export_simulation on Thu Dec 25 00:59:50 -0500 2025
#
################################################################################
...
'-reset_run' switch to the './modulo30_mult_gen_1.sh' script.

./modulo30_mult_gen_1.sh -reset_run
...
./modulo30_mult_gen_1.sh -noclean_files

For more information on the script, please type './modulo30_mult_gen_1.sh -help'.
