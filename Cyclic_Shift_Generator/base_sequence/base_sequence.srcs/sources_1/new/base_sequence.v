...
module base_sequence(
	...
	always @(posedge clk)
		if (rst) begin
			...
			disable_valid <= in_valid ? uci_grouphopping==2: disable_valid;
			enable_valid <= in_valid ? uci_grouphopping==1: enable_valid;
		end
	...
	scramble_sequence_8bits_0 scramble_sequence_8bits_0 (
	  ...
	  .markP({2'b00, mark_p}),          // input wire [7 : 0] markP
	...
	scramble_sequence_1bit_0 scramble_sequence_1bit_0 (
	  ...
	  .ID(disable_cinit),                // input wire [12 : 0] ID
	  .markP({2'd0, mark_p}),          // input wire [7 : 0] markP
