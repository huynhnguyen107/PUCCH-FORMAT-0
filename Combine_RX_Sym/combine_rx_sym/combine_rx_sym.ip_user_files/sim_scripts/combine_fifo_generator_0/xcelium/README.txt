...
#
# Generated by export_simulation on Sun Dec 28 14:27:46 -0500 2025
#
################################################################################
...
'-reset_run' switch to the './combine_fifo_generator_0.sh' script.

./combine_fifo_generator_0.sh -reset_run
...
./combine_fifo_generator_0.sh -noclean_files

For more information on the script, please type './combine_fifo_generator_0.sh -help'.
