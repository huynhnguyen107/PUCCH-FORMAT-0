...
#
# Generated by export_simulation on Sun Dec 28 02:04:04 -0500 2025
#
################################################################################
...
'-reset_run' switch to the './correlation_cordic_0.sh' script.

./correlation_cordic_0.sh -reset_run
...
./correlation_cordic_0.sh -noclean_files

For more information on the script, please type './correlation_cordic_0.sh -help'.
