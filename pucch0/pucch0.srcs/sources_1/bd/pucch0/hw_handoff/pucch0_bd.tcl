...
proc create_root_design { parentCell } {
  ...
  set i_pucch_valid [ create_bd_port -dir I i_pucch_valid ]
  ...
  set ulcch_para [ create_bd_port -dir I -from 511 -to 0 -type data ulcch_para ]
  ...
  connect_bd_net -net clk_1 [get_bd_ports clk] [get_bd_pins combine_rx_sym_0/clk] [get_bd_pins correlation_0/clk] [get_bd_pins cyclic_gen_0/clk] [get_bd_pins cyclic_gen_1/clk] [get_bd_pins demapping_0/clk] [get_bd_pins frame_sync_0/clk] [get_bd_pins frame_sync_1/clk] [get_bd_pins ofdm_demodulation_0/clk] [get_bd_pins peak_search_0/clk] [get_bd_pins physical_control_0/clk] [get_bd_pins rx_duplication_0/clk] [get_bd_pins sync_cyclic_0/clk] [get_bd_pins ulcch_parameter_0/clk]
  ...
  connect_bd_net -net correlation_0_sqrt [get_bd_pins correlation_0/sqrt] [get_bd_pins xlconcat_1/In0] [get_bd_pins xlconcat_1/In1] [get_bd_pins xlconcat_1/In2] [get_bd_pins xlconcat_1/In3] [get_bd_pins xlconcat_1/In4] [get_bd_pins xlconcat_1/In5] [get_bd_pins xlconcat_1/In6] [get_bd_pins xlconcat_1/In7]
  connect_bd_net -net correlation_0_sqrt_valid [get_bd_pins combine_rx_sym_0/in_valid] [get_bd_pins correlation_0/sqrt_valid]
  connect_bd_net -net cyclic_gen_0_cyclic_shift [get_bd_pins cyclic_gen_0/cyclic_shift] [get_bd_pins sync_cyclic_0/cyclic_0]
  connect_bd_net -net cyclic_gen_0_cyclic_shift_valid [get_bd_pins cyclic_gen_0/cyclic_shift_valid] [get_bd_pins sync_cyclic_0/valid_0]
  connect_bd_net -net cyclic_gen_1_cyclic_shift [get_bd_pins cyclic_gen_1/cyclic_shift] [get_bd_pins sync_cyclic_0/cyclic_1]
  connect_bd_net -net cyclic_gen_1_cyclic_shift_valid [get_bd_pins cyclic_gen_1/cyclic_shift_valid] [get_bd_pins sync_cyclic_0/valid_1]
  connect_bd_net -net demapping_0_resoureset0_valid [get_bd_pins rx_duplication_0/resource_set0]
  connect_bd_net -net demapping_0_resoureset1_valid [get_bd_pins rx_duplication_0/resource_set1]
  connect_bd_net -net demapping_0_two_symbol_valid [get_bd_pins rx_duplication_0/two_symbol_valid]
  ...
  connect_bd_net -net group_hopping_1 [get_bd_pins cyclic_gen_0/uci_grouphopping] [get_bd_pins cyclic_gen_1/uci_grouphopping] [get_bd_pins ulcch_parameter_0/group_hopping]
  ...
  connect_bd_net -net layer2_para_1 [get_bd_ports ulcch_para] [get_bd_pins ulcch_parameter_0/ulcch_para]
  connect_bd_net -net layer2_parameter_0_uci_ack [get_bd_pins cyclic_gen_0/uci_ack] [get_bd_pins cyclic_gen_1/uci_ack] [get_bd_pins peak_search_0/uci_ack] [get_bd_pins ulcch_parameter_0/uci_ack]
  connect_bd_net -net layer2_parameter_0_uci_frist_symbol [get_bd_pins cyclic_gen_0/uci_first_symbol] [get_bd_pins cyclic_gen_1/uci_first_symbol] [get_bd_pins demapping_0/uci_first_symbol_idx] [get_bd_pins ulcch_parameter_0/uci_frist_symbol]
  connect_bd_net -net layer2_parameter_0_uci_m0 [get_bd_pins cyclic_gen_0/uci_m0] [get_bd_pins cyclic_gen_1/uci_m0] [get_bd_pins ulcch_parameter_0/uci_m0]
  connect_bd_net -net layer2_parameter_0_uci_nid [get_bd_pins cyclic_gen_0/uci_nID] [get_bd_pins cyclic_gen_1/uci_nID] [get_bd_pins ulcch_parameter_0/hopping_ID]
  connect_bd_net -net layer2_parameter_0_uci_valid [get_bd_pins cyclic_gen_0/in_valid] [get_bd_pins cyclic_gen_1/in_valid] [get_bd_pins demapping_0/uci_valid] [get_bd_pins peak_search_0/in_uci_valid] [get_bd_pins ulcch_parameter_0/pucch_valid]
  connect_bd_net -net layer2_valid_1 [get_bd_ports i_pucch_valid] [get_bd_pins ulcch_parameter_0/i_pucch_valid]
  ...
  connect_bd_net -net rst_1 [get_bd_ports rst] [get_bd_pins combine_rx_sym_0/rst] [get_bd_pins correlation_0/rst] [get_bd_pins cyclic_gen_0/rst] [get_bd_pins cyclic_gen_1/rst] [get_bd_pins demapping_0/rst] [get_bd_pins frame_sync_0/rst] [get_bd_pins frame_sync_1/rst] [get_bd_pins ofdm_demodulation_0/rst] [get_bd_pins peak_search_0/rst] [get_bd_pins physical_control_0/rst] [get_bd_pins rx_duplication_0/rst] [get_bd_pins sync_cyclic_0/rst] [get_bd_pins ulcch_parameter_0/rst]
  connect_bd_net -net rx_duplication_0_ofdm_resource_ext [get_bd_pins rx_duplication_0/ofdm_resource_ext] [get_bd_pins xlslice_1/Din]
  ...
  connect_bd_net -net slot_ind_1 [get_bd_pins cyclic_gen_0/uci_slot] [get_bd_pins cyclic_gen_1/uci_slot] [get_bd_pins demapping_0/uci_slot] [get_bd_pins ulcch_parameter_0/uci_slot_idx]
  ...
  connect_bd_net -net ulcch_parameter_0_uci_intra_fre_hopping [get_bd_pins demapping_0/uci_instra_fre_hop] [get_bd_pins ulcch_parameter_0/uci_intra_fre_hopping]
  ...
  connect_bd_net -net ulcch_parameter_0_uci_symbol [get_bd_pins demapping_0/uci_nsymbols] [get_bd_pins ulcch_parameter_0/uci_symbol]
  connect_bd_net -net xlconcat_0_dout [get_bd_pins rx_duplication_0/in_ofdm] [get_bd_pins xlconcat_0/dout]
  connect_bd_net -net xlconcat_1_dout [get_bd_pins combine_rx_sym_0/in_sqrt] [get_bd_pins xlconcat_1/dout]
  connect_bd_net -net xlconstant_0_dout [get_bd_pins cyclic_gen_1/uci_nhop] [get_bd_pins cyclic_gen_1/uci_sym_alloc] [get_bd_pins xlconstant_1/dout]
  connect_bd_net -net xlconstant_1_dout [get_bd_pins cyclic_gen_0/uci_nhop] [get_bd_pins cyclic_gen_0/uci_sym_alloc] [get_bd_pins xlconstant_0/dout]
  ...
  connect_bd_net -net xlslice_1_Dout [get_bd_pins correlation_0/resourcesetresourceset] [get_bd_pins xlslice_1/Dout]
